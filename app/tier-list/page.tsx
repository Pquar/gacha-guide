                ...
                {tierGroups[
                  ...
                  (hero) => (
                    <Link
                      ...
                      className="flex items-center space-x-4 rounded-lg border p-3 dark:border-gray-700"
                    >
...
export default async function TierListPage() {
  ...
  const heroes: Heroes[] =
    heroesData as unknown as Heroes[];
        ...
        description={
          <>
            ...
            <p className="mt-3 italic">
              ...
              >
                <GrowingUnderline className="text-blue-500">
                  Learn how we
                  rank heroes
                </GrowingUnderline>
              </Link>
